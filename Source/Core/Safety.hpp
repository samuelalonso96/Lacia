...
#define $reliable(...) (::Lacia::Detail::Safe<> __VA_OPT__(,) __VA_ARGS__)
#define $unreliable(...) (::Lacia::Detail::Safe<false> __VA_OPT__(,) __VA_ARGS__)
#define $(...) (do_not_use_safe_object_private_and_secret __VA_OPT__(,) __VA_ARGS__)
#define $unsafe if constexpr([[maybe_unused]] constexpr ::Lacia::Detail::Safe<false> \
do_not_use_safe_object_private_and_secret; true)
#define $safe if constexpr([[maybe_unused]] constexpr ::Lacia::Detail::Safe<> \
do_not_use_safe_object_private_and_secret; true)
